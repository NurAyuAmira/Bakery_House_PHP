        ...
        <div class="container-fluid px-3"> 
            ...
            <div class="collapse navbar-collapse justify-content-end" id="collapsibleNavbar" style="font-size:x-large;font-weight: bold;">
                <ul class="navbar-nav text-uppercase">
                    ...
                    <li class="nav-item">
                        <a class="nav-link px-3" href="view%20staff.php" id="active">Staff</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="tab-content">
                ...
                <div id="view" class="tab-pane">
                    ...
                    <div class="table-responsive mt-2">
                        <h4><span class="badge bg-secondary" id="pickedup">Staff Detail's</span></h4>
                           ...
                           <?php
                                    ...
                                    if(mysqli_num_rows($result)!=0)
                                    {
                                        while($row = mysqli_fetch_assoc($result))
                                        {
                                            ...
                                            $custResult = mysqli_query($connect,"select * from staff where Staff_ID LIKE '$staffID'");
                                            $custRow = mysqli_fetch_assoc($custResult);
                                ?>
                                            <tr>
                                                <th><?php echo $row["Staff_ID"]?></th>
                                                <th><?php echo $row["Staff_First_Name"]?></th>
                                                <th><?php echo $row["Staff_Last_Name"]?></th>
                                                <th><?php echo $row["Staff_Email"]?></th>
                                                <th><?php echo $row["Staff_Gender"]?></th>
                                                <th><?php echo $row["Staff_Contact_No"]?></th>
                                                <th><?php echo $row["Staff_Address"]?></th>
                                                <th><?php echo $row["Staff_Address_Postcode"]?></th>
                                                <th><?php echo $row["Staff_Address_City"]?></th>
                                                <th><?php echo $row["Staff_Address_State"]?></th>
