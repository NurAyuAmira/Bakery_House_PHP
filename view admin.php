        ...
        <div class="container-fluid px-3"> 
            ...
            <div class="collapse navbar-collapse justify-content-end" id="collapsibleNavbar" style="font-size:x-large;font-weight: bold;">
                <ul class="navbar-nav text-uppercase">
                    <li class="nav-item">
                        <a class="nav-link px-3" href="staff%20order.php" >Order</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link px-3" href="view%20customer2.php">Customer</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link px-3" href="view%20admin.php" id="active">Admin</a>
                    </li>
            ...
            <div class="tab-content">
                ...
                <div id="view" class="tab-pane">
                    ...
                    <div class="table-responsive mt-2">
                        <h4><span class="badge bg-secondary" id="pickedup">Admin Detail's</span></h4>
                           ...
                           <?php
                                    ...
                                    if(mysqli_num_rows($result)!=0)
                                    {
                                        while($row = mysqli_fetch_assoc($result))
                                        {
                                            ...
                                            $custResult = mysqli_query($connect,"select * from admin where Admin_ID LIKE '$adminID'");
                                            $custRow = mysqli_fetch_assoc($custResult);
                                ?>
                                            <tr>
                                                <th><?php echo $row["Admin_ID"]?></th>
                                                <th><?php echo $row["Admin_First_Name"]?></th>
                                                <th><?php echo $row["Admin_Last_Name"]?></th>
                                                <th><?php echo $row["Admin_Email"]?></th>
                                                <th><?php echo $row["Admin_Gender"]?></th>
                                                <th><?php echo $row["Admin_Contact_No"]?></th>
                                                <th><?php echo $row["Admin_Address"]?></th>
                                                <th><?php echo $row["Admin_Address_Postcode"]?></th>
                                                <th><?php echo $row["Admin_Address_City"]?></th>
                                                <th><?php echo $row["Admin_Address_State"]?></th>
