    ...
    <div class="row vh-100">
        ...
        <div class="col text-center mt-5 pt-5">
            ...
            <div class="container shadow-sm my-5 bg-light py-4" style="max-width: 80%;">
                <h3><i class="bi bi-key-fill" style="color:brown;"></i>&nbsp;Forgot Password</h3>
                <?php
                    if(isset($_GET["step"]))
                    {
                        if($_GET["step"]=="1")
                ...
                ?>
                            <form action="" method="post" class="text-start">
                                <div class="mt-4">
                                    <label for="email" class="form-label"><i class="bi bi-envelope-fill" style="color:brown;"></i>&nbsp; Verify Your Email :</label>
                                    <input type="email" class="form-control" id="email" placeholder="Enter Your Email" name="email" required>
                                </div>
                                <div class="mt-5">
                                    <button type="submit" class="form-control btn btn-warning text-white" id="verify" name="verifybtn" style="background-color:#4d3f32">VERIFY</button>
                                </div>
                            </form>
                            <hr class="my-5">
                            <div class="row">
                                <div class="col text-start"><a href="user login.php">Login</a></div>
                            </div>
                <?php
                        }
                ...
                ?>
                            <form action="" method="post" class="text-start">
                                ...
                                <div class="mt-5">
                                    <button type="submit" class="form-control btn btn-warning text-white" id="verifyotp" name="verifyotpbtn" style="background-color:#4d3f32">VERIFY</button>
                                </div>
                            </form>
                            <hr class="my-5">
                            <div class="row">
                ...
                ?>
                            <form action="" method="post" class="text-start" onsubmit="return(validatePassword());">
                                ...
                                <div class="mt-5">
                                    <button type="submit" class="form-control btn btn-warning text-white" id="reset" name="resetbtn"style="background-color:#4d3f32">RESET PASSWORD</button>
                                </div>
                            </form>
                            <hr class="my-5">
                            <div class="row">
                ...
                <?php
                        ...
                        {
                            header("Location: forgotpwd.php?step=1");
                        }
                    }
                    else
                    {
...
<?php
    ...
    if(isset($_POST["verifybtn"]))
    {
        ...
        $input = mysqli_query($connect,"select * from customer where Customer_Email LIKE '$email' ");
        ...
        if($row>0)
        {
            ...
            try {
                ...
                $mail->Subject = "BakeryHouse - Verify Your OTP";
                        $mail->Body = 
                        "<p>Dear Customer,</p>
                        <br>
            ...
            ?>
                <script>
                    ...
                    location.href="forgotpwd.php?step=2";
                </script>
            <?php
            } catch (Exception $e) {
?>
...
?>
            <script>
                ...
                location.href="forgotpwd.php?step=1";
            </script>
<?php
        }
    }
...
?>
            <script>
                location.href="forgotpwd.php?step=3";
            </script>
<?php
        }
        else
...
<?php
    if(isset($_POST["resetbtn"]))
    {
        ...
        mysqli_query($connect,"update customer set Customer_Password = '$newPwd' where Customer_Email LIKE '$email'");
        unset($_SESSION["otp"]);
