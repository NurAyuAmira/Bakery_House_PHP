    ...
    <div class="row vh-100">
        ...
        <div class="col text-center mt-5 pt-5">
            ...
            <div class="container shadow-sm my-5 bg-light py-4" style="max-width: 80%;">
                <h3><i class="bi bi-people-fill" style="color:brown;"></i>&nbsp; User Login</h3>
                <form action="" method="post" class="text-start">
                    ...
                    <div class="mt-5">
                        <button type="submit" class="form-control btn btn-warning text-white" id="login" name="loginbtn" style="background-color:#4d3f32">LOGIN</button>
                    </div>
                </form>
                <hr class="my-5">
                <div class="row">
                    <div class="col text-start"><a href="forgotpwd.php?step=1">Forgot password?</a></div>
                    <div class="col text-end"><a href="user registration.php">Register</a></div>
                </div>
            </div>
        </div>
    </div>
...
<?php
    if(isset($_POST["loginbtn"]))
    {
        ...
        $input = mysqli_query($connect,"select * from customer where Customer_Email LIKE '$email' and Customer_Password = '$password' ");
