        ...
        <div class="row vh-100">
            ...
            <div class="col text-center mt-5 pt-5">
                ...
                <div class="container shadow-sm mt-5 bg-light py-4" style="max-width: 80%;">
                    <h3><i class="bi bi-people-fill"></i>&nbsp;Staff Login</h3>
                    ...
                    <hr class="my-5">
                    <div class="row">
                        <div class="col text-start"><a href="staff forgotpwd.php?step=1">Forgot password?</a></div>
                        <div class="col text-end"><a href="staff%20registration.php">Register</a></div>
                    </div>
                </div>
            </div>
        </div>
...
<?php
    if(isset($_POST["loginbtn"]))
    {
        ...
        $input = mysqli_query($connect,"select * from staff where Staff_Email = '$email' and Staff_Password = '$password'");
