            ...
            <div class="col text-center mt-5 pt-5">
                ...
                <div class="container shadow-sm mt-5 bg-light py-4" style="max-width: 80%;">
                    ...
                    ?>
                                ...
                                <hr class="my-5">
                                <div class="row">
                                    <div class="col text-start"><a href="admin login.php">Login</a></div>
                                </div>
                    <?php
                            }
                    ...
                    <?php
                            ...
                            {
                                header("Location: admin forgotpwd.php?step=1");
                            }
                        }
                        else
                        {
...
<?php
    ...
    if(isset($_POST["verifybtn"]))
    {
        ...
        $input = mysqli_query($connect,"select * from admin where Admin_Email LIKE '$email' ");
        ...
        if($row>0)
        {
            ...
            ?>
                <script>
                    ...
                    location.href="admin forgotpwd.php?step=2";
                </script>
            <?php
            } catch (Exception $e) {
?>
...
?>
            <script>
                ...
                location.href="admin forgotpwd.php?step=1";
            </script>
<?php
        }
    }
...
?>
            <script>
                location.href="admin forgotpwd.php?step=3";
            </script>
<?php
        }
        else
...
<?php
    if(isset($_POST["resetbtn"]))
    {
        ...
        mysqli_query($connect,"update admin set Admin_Password = '$newPwd' where Admin_Email LIKE '$email'");
        unset($_SESSION["otp"]);
